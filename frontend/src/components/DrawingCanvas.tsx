...
const DrawingCanvas = forwardRef<DrawingCanvasHandle, DrawingCanvasProps>(({ className }, ref) => {
  ...
  return (
    <div className={`flex flex-col gap-3 ${className ?? ''}`}>
      ...
      <div className="flex items-center gap-3 flex-wrap">
          ...
          {COLORS.map((c) => (
            <button
              ...
              style={{
                ...
                boxShadow: color === c.value ? `0 0 0 2px #0d0f14, 0 0 0 4px ${c.value}` : 'none',
              }}
            />
          ))}
        </div>
        ...
        <div className="flex items-center gap-1.5 ml-auto">
          ...
          <div
            ...
            style={{ width: `${strokeSize}px`, height: `${strokeSize}px`, minWidth: '4px', minHeight: '4px' }}
          />
          <Button
            type="button"
            variant="ghost"
      ...
      <div
        ref={containerRef}
        className="relative rounded-xl overflow-hidden border border-border/40 cursor-crosshair"
